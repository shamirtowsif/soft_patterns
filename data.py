...
def read_docs(filename, vocab, num_padding_tokens=1):
    ...
    return [pad(vocab.numberize(doc), num_padding_tokens=num_padding_tokens, START=START_TOKEN_IDX, END=END_TOKEN_IDX) for doc in docs], [pad(doc, num_padding_tokens=num_padding_tokens, START=START_TOKEN, END=END_TOKEN) for doc in docs]
